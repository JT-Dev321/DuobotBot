...
STEAM_LEVEL_OAUTH_URL = f"https://discord.com/api/oauth2/authorize?client_id={os.getenv("DISCORD_CLIENT_ID")}&redirect_uri=" + "http://jt-dev.xyz/callback" + "&response_type=code&scope=identify%20connections"
